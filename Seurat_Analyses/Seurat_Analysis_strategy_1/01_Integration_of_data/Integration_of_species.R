...
SAM_1E <- CreateSeuratObject(counts = COL_SAM, project = "SAM_1E", min.cells = 6, min.features = 200)
...
fileGenerator(anchFeatures, "HVG_anchor_features.txt")
...
save(Liger_object_K_50, file = "integrated_wt_hirsta_apex_seurat.RData")
