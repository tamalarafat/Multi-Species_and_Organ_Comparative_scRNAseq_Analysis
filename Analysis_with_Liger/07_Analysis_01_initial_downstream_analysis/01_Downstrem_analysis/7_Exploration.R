...
resolution_explorer_series_of_seurat_objects <- function(seurat_object_dir, 
  ...
  for (i in c(1:length(seuratObjects))){
    ...
    integrated.data$Replicates <- factor(integrated.data$Replicates, levels = c("O1", "O2", "O3", "O7", "S1"), labels = c("OX-1", "OX-2", "OX-3", "OX-7", "SAM-1"))
...
seurat_files_dir = "/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Analyses/comparative_study_Cardamine_and_Arabidopsis_Apex/Liger_Analyses/Liger_Analysis_strategy_2/On_coefficient/Seurat_objects"

# Storing directory
storing_dir = "/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Analyses/comparative_study_Cardamine_and_Arabidopsis_Apex/Liger_Analyses/Liger_Analysis_strategy_2/On_coefficient"
