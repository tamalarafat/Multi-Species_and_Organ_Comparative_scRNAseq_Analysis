...
# Storing directory
res_dir = "/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Analyses/comparative_study_Cardamine_and_Arabidopsis_Apex/Liger_Analyses/Liger_Analysis_strategy_2/On_coefficient"
