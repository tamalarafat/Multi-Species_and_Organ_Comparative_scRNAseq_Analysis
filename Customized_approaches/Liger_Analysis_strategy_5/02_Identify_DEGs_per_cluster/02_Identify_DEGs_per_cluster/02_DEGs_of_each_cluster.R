...
# Storing directory
res_dir = "/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Analyses/comparative_study_Cardamine_and_Arabidopsis_Apex/Liger_Analyses/Liger_Analysis_strategy_5/On_coefficient"

load("/biodata/dep_tsiantis/grp_laurent/tamal/2023/comparative_study_Cardamine_and_Arabidopsis_Apex/Liger_Analyses/Liger_Analysis_strategy_5/On_coefficient/Seurat_objects/seurat_object_of_K_50.RData")
